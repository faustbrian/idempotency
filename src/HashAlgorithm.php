...
use Cline\Idempotency\Exceptions\UnsupportedHashAlgorithmException;
...
enum HashAlgorithm: string
{
     ...
     *
     * @throws UnsupportedHashAlgorithmException If the algorithm is not supported
     *
    ...
    public static function fromString(string $algorithm): self
    {
        return match (mb_strtolower($algorithm)) {
            ...
            default => throw UnsupportedHashAlgorithmException::forAlgorithm($algorithm),
        };
    }
